...
public class procesoDos {
	...
	public void iniciarDos() {
		...
		case "#6":
			...
			System.out.println( numeroSeis(tama));
			break;
		case "#7":
			...
			break;
		case "#8":
			Integer numeroso=Integer.parseInt(JOptionPane.showInputDialog("Cuantos estudiantes desea registrar"));
			System.out.println(numeroOcho(numeroso));
			break;
		case "Salir":
			break;
		default:
